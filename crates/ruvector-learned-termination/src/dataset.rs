...
/// Cluster-structured dataset: `num_clusters` Gaussian blobs on the unit sphere.
...
/// Brute-force exact top-k nearest neighbours by L2² distance.
...
mod tests {
    ...
    #[test]
    fn ground_truth_self_is_nearest() {
        let corpus = random_unit_vectors(50, 8, 3);
        let gt = ground_truth(&corpus[7], &corpus, 5);
        assert_eq!(gt[0], 7);
    }
}
